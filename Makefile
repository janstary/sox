...
FORMAT_SRCS = \
	...
	tx16w.c voc.c vox.c vox.h vox-fmt.c wav.c wve.c w64.c xa.c \
...
EXTERNAL_SRCS += mp3.c mp3-util.h opus.c speexdsp.c spectrogram.c vorbis.c wavpack.c
...
FORMAT_OBJS = \
	...
	tx16w.o voc.o vox.o vox-fmt.o wav.o wve.o w64.o xa.o \
